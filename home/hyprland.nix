...
# GUI/Hyprland-specific home-manager config.
# Imported by home/common.nix only when the host enables Hyprland
# (i.e. osConfig.programs.hyprland.enable == true).

let
  hostHasNvidia = osConfig.hardware.nvidia.modesetting.enable or false;
